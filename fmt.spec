...
Source0  : https://github.com/fmtlib/fmt/archive/11.0.0/fmt-11.0.0.tar.gz
...
%prep
%setup -q -n fmt-11.0.0
cd %{_builddir}/fmt-11.0.0
pushd ..
cp -a fmt-11.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719963182
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfmt.so.11.0.0
/usr/lib64/libfmt.so.11
/usr/lib64/libfmt.so.11.0.0
